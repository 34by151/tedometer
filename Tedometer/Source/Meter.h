...
@property(weak, readonly) NSString* meterTitle;
@property(weak, readonly) NSString* meterTitleWithMtuNumber;
@property(weak, readonly) NSString* todayPeakTimeString;
@property(weak, readonly) NSString* todayMinTimeString;
@property(weak, readonly) NSString* mtdPeakTimeString;
@property(weak, readonly) NSString* mtdMinTimeString;
...
@property(weak, readonly) NSString* todayLowLabel;
@property(weak, readonly) NSString* todayAverageLabel;
@property(weak, readonly) NSString* todayPeakLabel;
@property(weak, readonly) NSString* todayTotalLabel;
@property(weak, readonly) NSString* todayProjectedLabel;
@property(weak, readonly) NSString* mtdLowLabel;
@property(weak, readonly) NSString* mtdAverageLabel;
@property(weak, readonly) NSString* mtdPeakLabel;
@property(weak, readonly) NSString* mtdTotalLabel;
@property(weak, readonly) NSString* mtdProjectedLabel;
